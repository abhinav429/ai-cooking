...
import { PricingSubscribeSignInButton } from "@/components/AuthNavButtons";
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        ...
        <Card className="border-2 border-border bg-white">
          <CardHeader>
            ...
            <div className="text-5xl font-bold text-foreground">
              $0
              <span className="text-lg font-normal text-muted-foreground/80">/mo</span>
            </div>
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={i} className="flex gap-3 text-foreground/90">
                  <Check className="h-5 w-5 shrink-0 mt-0.5 text-muted-foreground/80" />
                  <span>{item}</span>
                </li>
              ))}
            </ul>
        ...
        <Card className="relative border-2 border-orange-600 bg-orange-50">
          ...
          <CardFooter>
            <ClerkLoading>
              <div
                className="h-11 w-full rounded-md bg-orange-200/60 animate-pulse"
                aria-hidden
              />
            </ClerkLoading>
            <ClerkLoaded>
              <SignedIn>
                <CheckoutButton
                  planId="cplan_3CCWkGcEJ7xHFZGQbCG1oeA2fE5"
                  planPeriod="month"
