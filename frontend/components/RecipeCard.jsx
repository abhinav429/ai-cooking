...
export default function RecipeCard({ recipe, variant = "default" }) {
  ...
  if (variant === "grid") {
    return (
      <Link href={data.href}>
        <Card className="rounded-none overflow-hidden border-border hover:shadow-xl hover:-translate-y-1 transition-all duration-300 cursor-pointer group pt-0">
          {/* Image */}
          {data.showImage ? (
            ...
            <div className="relative aspect-square bg-gradient-to-br from-orange-600 via-yellow-400 to-orange-400 flex items-center justify-center">
          ...
          {/* Title */}
          <CardHeader>
            <CardTitle className="text-lg font-bold text-foreground group-hover:text-orange-600 transition-colors line-clamp-2">
              {data.title}
            </CardTitle>
          </CardHeader>
        </Card>
  ...
  if (variant === "list") {
    return (
      <Link href={data.href}>
        <Card className="rounded-none border-border hover:shadow-lg hover:border-orange-200 transition-all cursor-pointer group overflow-hidden py-0">
          <div className="flex flex-col md:flex-row">
            ...
            {data.showImage ? (
              ...
              <div className="relative w-full md:w-48 aspect-video md:aspect-square flex-shrink-0 bg-gradient-to-br from-orange-600 to-orange-400 flex items-center justify-center">
