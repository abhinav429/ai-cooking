    ...
    <div className="min-h-screen bg-background pt-24 pb-16 px-4">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="mb-8">
          <Link
            href="/pantry"
            className="inline-flex items-center gap-2 text-muted-foreground hover:text-orange-600 transition-colors mb-4 font-medium"
          >
          ...
          {/* Ingredients Used */}
          {ingredientsUsed && (
            <div className="bg-white p-4 border-2 border-border mb-4">
        ...
        {!loading && recipes.length > 0 && (
          <div>
            <div className="flex items-center justify-between mb-6">
              ...
              <Badge
                variant="outline"
                className="border-2 border-stone-900 text-foreground font-bold uppercase tracking-wide"
              >
        ...
        {!loading && recipesData === undefined && (
          <div className="bg-linear-to-br from-orange-50 to-orange-50 p-12 text-center border-2 border-orange-200">
