      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="mb-4">
          ...
          {itemsData?.scansLimit !== undefined && (
            <div className="bg-white py-3 px-4 border-2 border-border inline-flex items-center gap-3">
        ...
        {!loadingItems && items.length > 0 && (
          <div>
            <div className="flex items-center justify-between mb-6">
              ...
              <Badge
                variant="outline"
                className="text-muted-foreground border-2 border-stone-900 font-bold uppercase tracking-wide"
              >
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {items.map((item) => (
                <div
                  key={item.documentId}
                  className="bg-white p-5 border-2 border-border hover:border-orange-600 hover:shadow-lg transition-all"
                >
                  {editingId === item.documentId ? (
                    ...
                    <div className="space-y-3">
                      <input
                        ...
                        className="w-full px-3 py-2 border-2 border-border focus:outline-none focus:border-orange-600 text-sm"
                      ...
                      <div className="flex items-start justify-between mb-3">
                        ...
                        <div className="flex gap-1">
                          <button
                            ...
                            className="p-2 border-2 border-transparent hover:border-orange-600 hover:bg-orange-50 transition-all text-muted-foreground hover:text-orange-600"
                          >
                          ...
                          <button
                            ...
                            disabled={deleting}
                            className="p-2 border-2 border-transparent hover:border-red-600 hover:bg-red-50 transition-all text-muted-foreground hover:text-red-600"
                          >
        ...
        {/* Empty State */}
        {!loadingItems && items.length === 0 && (
          <div className="bg-white p-12 text-center border-2 border-dashed border-border">
