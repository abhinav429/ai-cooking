          ...
          <div className="text-center py-20">
            ...
            <div className="mt-8 max-w-md mx-auto">
              <div className="flex items-center gap-3 text-sm text-muted-foreground">
                <div className="flex-1 h-1 bg-muted overflow-hidden relative">
    ...
    <div className="min-h-screen bg-background pt-24 pb-16 px-4">
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="mb-8">
          ...
          {/* Title Section */}
          <div className="bg-white p-8 md:p-10 border-2 border-border mb-6">
            {/* Badges */}
            {recipe.imageUrl && (
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 space-y-6">
            {/* Ingredients */}
            <div className="bg-white p-6 border-2 border-border lg:sticky lg:top-24">
                ...
                <div key={category} className="mb-6 last:mb-0">
                  ...
                  <ul className="space-y-2">
                    {items.map((ingredient, i) => (
                      <li
                        key={i}
                        className="flex justify-between items-start gap-2 text-foreground/90 py-2 border-b border-border/60 last:border-0"
                      >
                ...
                <div className="mt-6 pt-6 border-t-2 border-border">
                  ...
                  >
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="bg-background p-3 text-center border-2 border-border/60">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {recipe.tips && recipe.tips.length > 0 && (
              <div className="bg-linear-to-br from-orange-50 to-orange-50 p-8 border-2 border-orange-200">
                <h2 className="text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                ...
                >
                  <div className="space-y-4">
                    {recipe.substitutions.map((sub, i) => (
                      <div
                        key={i}
                        className="border-b-2 border-border/60 pb-4 last:border-0 last:pb-0"
                      >
